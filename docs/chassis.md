...
Best used for: chasis <br>
This module will yield a four corner controls, which will be avaraged determine the main control's translation and orientation.  <br>
 <br>
</font>
</i>
<hr width = 100%>
